                      ...
                      const std::string debug_name)
{
  ...
  BOOST_CHECK(dim_x * dim_y == (size_t)E.rows());

  typedef Eigen::Matrix<complex<RealScalarType>, Eigen::Dynamic, Eigen::Dynamic> MatrixType;
  ...
  BOOST_CHECK( fabs(E.real().trace() - (double)dim_x) < 1e-8 );
